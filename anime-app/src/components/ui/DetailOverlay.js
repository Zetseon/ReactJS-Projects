...
import classes from "./DetailOverlay.module.css";
import { fetchMediaDetails } from "../hooks/FetchCalls";
import DOMPurify from "dompurify";
import CharacterItem from "../hooks/CharacterItem";
import VideoContainer from "../hooks/VideoContainer";
function DetailOverlay({ mediaId, onClose }) {
    ...
    function handleTrailer(trailerId,trailerSite) {
                        ...
                        <div className={classes.bodyData}>
                            ...
                            <div className={classes.body}>
                                <div className={classes.voiceActors}>
                                    <h4>Main Roles and Voice Actors:</h4>
                                    <ul>
